...
const it: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Offerta di lancio Xingzhan Chat, sblocca OpenAI o1, GPT-4o, Claude-3.5 e i più recenti modelli di grandi dimensioni",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usa Xingzhan Chat",
        Label: "(La soluzione più conveniente)",
        SubTitle:
          "Mantenuto ufficialmente da Xingzhan Chat, pronto all'uso senza configurazione, supporta i modelli più recenti come OpenAI o1, GPT-4o e Claude-3.5",
        ChatNow: "Chatta ora",
      },
